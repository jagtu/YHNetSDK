 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `YHModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface YHAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation YHAuthor
     @end
 
     @interface YHBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) YHAuthor *author;
     @end
     ...
     int main() {
         ...
         YHBook *book = [YHBook yh_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book yh_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface YHShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation YHShadow
 ...
 */
+ (nullable instancetype)yh_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)yh_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)yh_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)yh_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)yh_modelToJSONObject;
 ...
 */
- (nullable NSData *)yh_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)yh_modelToJSONString;
 ...
 */
- (void)yh_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)yh_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)yh_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (YHModel)
 ...
 */
+ (nullable NSDictionary *)yh_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<YHModel>' to your class header.
 */
@protocol YHModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class YHShadow, YHBorder, YHAttachment;
 
        @interface YHAttributes
        @property NSString *name;
        ...
        @implementation YHAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [YHShadow class],
                     @"borders" : YHBorder.class,
                     @"attachments" : @"YHAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class YHCircle, YHRectangle, YHLine;
 
        @implementation YHShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [YHCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [YHRectangle class];
